...
#     "return $line" % (query)
#     uchel
myquery = 'declare variable $doc as element() := \
            <cars><car id="1">Ford</car><car id="2">Mazda</car><car id="3">Toyota</car><car id="4">Lexus</car></cars>; \
            copy $d := $doc \
            modify delete node $d//*[@id="3"] \
            return $d'
# for $lines in collection('../../gutorglyn.bdbxml')//tei:div[@type='lev1']/tei:lg/tei:l \
