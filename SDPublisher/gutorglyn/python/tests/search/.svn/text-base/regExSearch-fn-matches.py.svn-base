...
#     "return $line" % (query)
#     uchel
myquery = "for $lines in collection('../../../gutorglyn.bdbxml')//tei:div[@type='lev1']/tei:lg/tei:l where some $line in $lines satisfies matches($line, '%s', 'imx') return $lines" % smart_str(query)    
