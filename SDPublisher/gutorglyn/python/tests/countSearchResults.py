...
myCount = 'declare namespace tei="http://www.tei-c.org/ns/1.0"; count(collection("../../gutorglyn.bdbxml")//tei:div[@type="lev1"]/tei:lg[contains(., "%s")])' % myStr
...
for value in countResults:
    content = value.asString()
    print 'Occurs in ' + content + ' line(s)'
