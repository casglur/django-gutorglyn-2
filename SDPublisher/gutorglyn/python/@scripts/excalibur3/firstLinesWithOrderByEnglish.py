...
mymgr = XmlManager()
myquery = "<select id='first-line' name='first-line'><option value='#'>Choose...</option> "
myquery = myquery + "{ for $x in collection('../../../gutorglyn.bdbxml')//tei:div[@type='lev2'][2] order by $x/tei:lg[2]/tei:l[1] return"
myquery = myquery + "<option value='{substring-before($x/@xml:id,'translation')}'>"
myquery = myquery + "{$x/tei:lg[2]/tei:l[1]/descendant-or-self::text()}"
