...
myquery = "<div class='patron-list'>{for $x in collection('../gutorglyn.bdbxml')//tei:div[@type='nodyn_noddwr'] order by $x/tei:div[@type='cym']/tei:head return <a href='/gutorglyn/patron/?n={$x/@xml:id}'>{$x/tei:div[@type='cym']/tei:head/descendant-or-self::text()}</a>}</div>"
