...
mymgr = XmlManager()
myquery = "<select id='first-line' name='first-line'><option value='#'>Dewis...</option> "
myquery = myquery + "{ for $x in collection('../../../gutorglyn.bdbxml')//tei:div[@type='lev1'] order by $x/tei:lg[1]/tei:l[1] return"
myquery = myquery + "<option value='{$x/@xml:id}'>"
myquery = myquery + "{$x/tei:lg[1]/tei:l[1]/descendant-or-self::text()}"
