...
searchStr = searchStr4.encode('ascii', 'xmlcharrefreplace')
...
myquery= ('\
     ...
     declare variable $poem_nodes as node()* := collection("/SDPublisher/SDPublisher/gutorglyn/gutorglyn.bdbxml")/tei:TEI/tei:text[1]/tei:body[1]/tei:div[1]/tei:div[1]/tei:div[1]/tei:lg/tei:l; \
     let $start := 0 \
     let $end := 10\
...
qcontext.setDefaultCollection("/SDPublisher/SDPublisher/gutorglyn/gutorglyn.bdbxml")
